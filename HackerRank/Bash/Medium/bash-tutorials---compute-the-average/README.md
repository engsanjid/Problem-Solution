...
| Difficulty | Medium |
| Language | Bash |
| Problem | [Open on HackerRank](https://www.hackerrank.com/challenges/bash-tutorials---compute-the-average/problem) |
| Test cases | 6 / 6 |
| Score | 1.0 |
| Verdict | Accepted |
| Submission | `481177139` |
| Tags | `Linux Shell`, `Bash` |
| Solved on | 2026-08-25 10:46 UTC |
